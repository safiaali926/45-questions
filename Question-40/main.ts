/*Album: Write a function called make_album() that builds a Object describing a music album. function should 
...
console.log(make_album("Atif Aslam", "Dil Diya Gallan"));
console.log(make_album("Arjit Singh", "Chal Wahan Jaate Hain"));
console.log(make_album("Arman Malik", "Wajah Tum Ho", 4));
