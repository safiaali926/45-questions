...
let current_users: string[] = [`SafiaAli` , `HunaidSiddique` , `PeterParker` , `TomHoland` , `Johncena`]
let new_users: string[] = [`TasmiaRafiq` , `Micheal` , `Junaidalam` , `Scarletwitch` , `SafiaAli`]
